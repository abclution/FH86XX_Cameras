#!/bin/sh
# Modification of idump.sh that makes individual mtd backup files & full flash.
...
do
        ...
        f_cp src=/dev/mtd$mtd_no soff=0 dst=${dst}mtd_$mtd_no.img len=$mtd_size
...
echo "Created full image dump at $dst$dst_img_name"
